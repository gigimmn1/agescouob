...
<html lang="fr">
  <head>
      ...
      <title>Bienvenue sur AGESCO-UOB</title>
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            @if (Route::has('login'))
                            @auth
                                <li><a  href="{{ url('/home') }}" class="btn btn-lg btn-primary page-scroll">Tableau de bord</a></li>
                            @else
                              <li><a href="{{ route('login') }}" class="btn btn-lg btn-info page-scroll">s'identifier</a></li>
                              @if (Route::has('register'))
                                <li><a href="{{ route('register') }}" class="btn btn-lg page-scroll">S'inscrire</a></li>
                              @endif
                            @endauth
                            @endif
                        </ul>
